mergeInto(LibraryManager.library, {
    ...
    PostJSON: function(path, value) {
        var parsedPath = Pointer_stringify(path);
        var parsedValue = Pointer_stringify(value);
        //var parsedObjectName = Pointer_stringify(objectName);
        //var parsedCallback = Pointer_stringify(callback);
        //var parsedFallback = Pointer_stringify(fallback);
        try {database().ref(parsedPath).set(JSON.parse(parsedValue));}
        catch (error) {alert(error);}

    },

    PushJSON: function(path, value) {
        var parsedPath = Pointer_stringify(path);
        var parsedValue = Pointer_stringify(value);
        //var parsedObjectName = Pointer_stringify(objectName);
        //var parsedCallback = Pointer_stringify(callback);
        ...
        const postListRef = db.child(parsedPath);
        try {postListRef.push(JSON.parse(parsedValue));}
        catch (error) {alert(error);}
